-- From R, need I, 20191, Chemistry, AA, 'CHEM 1 A', 'CHEM 1 B', 'CHEM 12 A', 'CHEM 12 B' -- 'BLANK', 4 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('CHEM 1 A', 'CHEM 1 B', 'CHEM 12 A', 'CHEM 12 B') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
