-- From R, need I, 20191, Art History, AAT, 'ART 80', 'ARTH 25', 'ARTH 26' -- 'BLANK', 3 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ART 80', 'ARTH 25', 'ARTH 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('ARTH 22', 'ARTH 23', 'ARTH 27') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('ART 40', 'ART 41', 'ART 50', 'ART 51', 'ART 82', 'ART 85', 'DMA 55') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		, sum(case when dc.CourseID in ('ARTH 1', 'ARTH 4', 'ARTH 22', 'ARTH 23', 'ARTH 24', 'ARTH 28', 'ARTH 29', 'ARTH 30', 'ARTH 31', 'ARTH 32', 'ARTH 110') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_04
