-- From R, need I, 20191, A+, Network+, Linux+, CP, 'CIM 110', 'CIM 106', 'CIM 108', 'CIM 160', 'CIM 161' -- 'BLANK', 3 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('CIM 110', 'CIM 106', 'CIM 108', 'CIM 160', 'CIM 161') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
