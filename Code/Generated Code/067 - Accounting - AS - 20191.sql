-- From R, need I, 20191, Accounting, AS, 'ACCT 1 A', 'ACCT 1 B', 'ACCT 1 BH', 'MGT 104' -- 'BLANK', 3 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ACCT 112 .1', 'CIM 107', 'CS 1', 'CS 1 H', 'MGT 1', 'MGT 12 A', 'MGT 12 AH') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
