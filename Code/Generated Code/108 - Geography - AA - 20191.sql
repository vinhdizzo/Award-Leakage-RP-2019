-- From R, need I, 20191, Geography, AA, 'GEOG 1', 'GEOG 1 L', 'GEOG 2', 'GEOG 3', 'GEOG 20', 'GEOG 38' -- 'BLANK', 6 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('GEOG 1', 'GEOG 1 L', 'GEOG 2', 'GEOG 3', 'GEOG 20', 'GEOG 38') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('GEOG 10', 'GEOG 12', 'GEOG 102') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
