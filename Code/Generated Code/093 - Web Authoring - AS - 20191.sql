-- From R, need I, 20191, Web Authoring, AS, 'CIM 141', 'CIM 143', 'CIM 144' -- 'BLANK', 3 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('CIM 145', 'CIM 148', 'CIM 249', 'CIM 251') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
