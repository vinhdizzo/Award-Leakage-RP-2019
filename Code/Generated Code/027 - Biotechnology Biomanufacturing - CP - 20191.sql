-- From R, need I, 20191, Biotechnology Biomanufacturing, CP, 'BIOT 70', 'BIOT 70 L', 'BIOT 273', 'BIOT 274', 'BIOT 275' -- 'BLANK', 5 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Biotechnology Biomanufacturing' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('BIOT 70', 'BIOT 70 L', 'BIOT 273', 'BIOT 274', 'BIOT 275') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
