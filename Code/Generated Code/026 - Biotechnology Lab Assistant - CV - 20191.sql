-- From R, need I, 20191, Biotechnology Lab Assistant, CV, 'BIOT 70', 'BIOT 70 L', 'BIOT 273', 'CHEM 3' -- 'BLANK', 4 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Biotechnology Lab Assistant' as Award_Name
		, 'CV' as Award_Type
		...
		, sum(case when dc.CourseID in ('BIOT 70', 'BIOT 70 L', 'BIOT 273', 'CHEM 3') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
