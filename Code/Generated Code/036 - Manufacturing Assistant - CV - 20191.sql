-- From R, need I, 20191, Manufacturing Assistant, CV, 'MGT 102', 'MGT 125', 'MGT 168', 'MGT 203', 'MATH 10' -- 'BLANK', 6 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('MGT 102', 'MGT 125', 'MGT 168', 'MGT 203', 'MATH 10') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
