-- From R, need I, 20191, Natural Sciences And Mathematics, AA, 'BIO 1', 'BIO 2', 'BIO 5', 'BIO 10', 'BIO 15', 'BIO 93', 'BIO 81', 'BIO 94', 'BIO 80', 'BIO 97', 'BIO 99', 'CHEM 1 A', 'CHEM 1 B', 'CHEM 12 A', 'CHEM 12 B', 'CS 36', 'CS 37', 'ERTH 20', 'BIO 13', 'BIO 19', 'BIO 30', 'BIO 101', 'BIO 103', 'BIO 104', 'BIO 110', 'BIO 140', 'GEOG 102', 'GEOL 140', 'GEOL 170', 'GEOL 181', 'GEOL 186', 'GEOL 1', 'GEOL 2', 'GEOL 3', 'MATH 3 A', 'MATH 3 B', 'MATH 4 A', 'MATH 24', 'MATH 26', 'MS 20', 'PHYS 2 A', 'PHYS 2 B', 'PHYS 4 A', 'PHYS 4 B', 'PHYS 4 C' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Natural Sciences And Mathematics' as Award_Name
		, 'AA' as Award_Type
		...
		, sum(case when dc.CourseID in ('BIO 1', 'BIO 2', 'BIO 5', 'BIO 10', 'BIO 15', 'BIO 93', 'BIO 81', 'BIO 94', 'BIO 80', 'BIO 97', 'BIO 99', 'CHEM 1 A', 'CHEM 1 B', 'CHEM 12 A', 'CHEM 12 B', 'CS 36', 'CS 37', 'ERTH 20', 'BIO 13', 'BIO 19', 'BIO 30', 'BIO 101', 'BIO 103', 'BIO 104', 'BIO 110', 'BIO 140', 'GEOG 102', 'GEOL 140', 'GEOL 170', 'GEOL 181', 'GEOL 186', 'GEOL 1', 'GEOL 2', 'GEOL 3', 'MATH 3 A', 'MATH 3 B', 'MATH 4 A', 'MATH 24', 'MATH 26', 'MS 20', 'PHYS 2 A', 'PHYS 2 B', 'PHYS 4 A', 'PHYS 4 B', 'PHYS 4 C') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		...
		, max(case when dc.CourseID in ('BIO 1', 'BIO 2', 'BIO 5', 'BIO 10', 'BIO 15', 'BIO 93', 'BIO 81', 'BIO 94', 'BIO 80', 'BIO 97', 'BIO 99') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_01
		, max(case when dc.CourseID in ('CHEM 1 A', 'CHEM 1 B', 'CHEM 12 A', 'CHEM 12 B') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_02
		, max(case when dc.CourseID in ('CS 36', 'CS 37') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_03
		, max(case when dc.CourseID in ('ERTH 20') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_04
		, max(case when dc.CourseID in ('BIO 13', 'BIO 19', 'BIO 30', 'BIO 101', 'BIO 103', 'BIO 104', 'BIO 110', 'BIO 140', 'GEOG 102', 'GEOL 140', 'GEOL 170', 'GEOL 181', 'GEOL 186') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_05
		, max(case when dc.CourseID in ('GEOL 1', 'GEOL 2', 'GEOL 3') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_06
		, max(case when dc.CourseID in ('MATH 3 A', 'MATH 3 B', 'MATH 4 A', 'MATH 24', 'MATH 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_07
		, max(case when dc.CourseID in ('MS 20') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_08
		, max(case when dc.CourseID in ('PHYS 2 A', 'PHYS 2 B', 'PHYS 4 A', 'PHYS 4 B', 'PHYS 4 C') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_09
