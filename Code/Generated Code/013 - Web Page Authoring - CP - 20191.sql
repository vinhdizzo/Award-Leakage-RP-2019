-- From R, need I, 20191, Web Page Authoring, CP, 'CIM 141', 'CIM 143', 'CIM 144' -- 'BLANK', 3 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Web Page Authoring' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('CIM 141', 'CIM 143', 'CIM 144') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
