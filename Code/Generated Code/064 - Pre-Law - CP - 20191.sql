-- From R, need I, 20191, Pre-Law, CP, 'LGL 205', 'LGL 215', 'MGT 12 A', 'RD 174' -- 'BLANK', 4 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('LGL 205', 'LGL 215', 'MGT 12 A', 'RD 174') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
