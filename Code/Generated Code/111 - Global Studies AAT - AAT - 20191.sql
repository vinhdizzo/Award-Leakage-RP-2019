-- From R, need I, 20191, Global Studies AAT, AAT, 'GLBL 1', 'GLBL 2' -- 'BLANK', 2 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Global Studies AAT' as Award_Name
		, 'AAT' as Award_Type
		...
		, sum(case when dc.CourseID in ('GLBL 1', 'GLBL 2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('ANTH 2', 'ANTH 2 H', 'HIST 1', 'HIST 1 H', 'HIST 2', 'GEOG 1', 'GEOG 1 L', 'GEOG 2', 'GEOG 3', 'GEOG 3 H', 'ECON 1', 'ECON 1 H', 'ECON 2', 'ECON 2 H', 'ECON 10', 'ECON 10 H', 'MGT 10', 'MGT 10 H', 'PSYC 10', 'PSYC 10 H', 'MATH 10', 'PS 12', 'PS 12 H', 'PS 14', 'PS 14 H', 'CHI 2', 'FR 3', 'FR 4', 'HUM 1', 'HUM 1 H', 'JA 3', 'JA 4', 'SPAN 3', 'SPAN 4') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
