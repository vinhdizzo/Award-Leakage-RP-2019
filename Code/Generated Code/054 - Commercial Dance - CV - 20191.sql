-- From R, need I, 20191, Commercial Dance, CV, 'DNCE 18', 'DNCE 23', 'DNCE 55' -- 'BLANK', 3 -- 0
...
(
	...
	, max(case
		-- certificates
		when a.Award_Type in ('CC', 'CO', 'CP', 'CV') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and N_Course_01 >= 3 and N_Course_02 >= 3 and N_Course_03 >= 2 and N_Course_04 >= 1 and N_Course_05 >= 2 and N_Course_06 >= 2 and N_Course_07 >= 1 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1
		-- degrees
	...
	, max(case when N_Course_01 >= 3 then 0 else 3 - N_Course_01 end) +
		...
		max(case when N_Course_06 >= 2 then 0 else 2 - N_Course_06 end) +
	...
	, max(case when N_Course_06 >= 2 then 0 else 2 - N_Course_06 end) as Gap_Major_Course_06
	...
	(
		select
		cur_stud.*
		, 'Commercial Dance' as Award_Name
		, 'CV' as Award_Type
		...
		, sum(case when dc.CourseID in ('DNCE 18', 'DNCE 23', 'DNCE 55') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('DNCE 51', 'DNCE 142', 'DNCE 253') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('DNCE 7', 'DNCE 13') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		, sum(case when dc.CourseID in ('DNCE 27', 'DNCE 36', 'DNCE 37', 'DNCE 40') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_04
		, sum(case when dc.CourseID in ('DNCE 33', 'DNCE 34', 'DNCE 35', 'DNCE 61') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_05
		, sum(case when dc.CourseID in ('DNCE 65', 'DNCE 170') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_06
		, sum(case when dc.CourseID in ('MUS 80', 'MUS 81', 'MUS 82', 'TA 1') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_07
