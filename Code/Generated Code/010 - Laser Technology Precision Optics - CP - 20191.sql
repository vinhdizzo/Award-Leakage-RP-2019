-- From R, need I, 20191, Laser Technology: Precision Optics, CP, 'LASR 25', 'LASR 215', 'LASR 225', 'LASR 235', 'LET 25', 'LET 215', 'LET 225', 'LET 235' -- 'BLANK', 4 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Laser Technology: Precision Optics' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('LASR 25', 'LASR 215', 'LASR 225', 'LASR 235', 'LET 25', 'LET 215', 'LET 225', 'LET 235') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
