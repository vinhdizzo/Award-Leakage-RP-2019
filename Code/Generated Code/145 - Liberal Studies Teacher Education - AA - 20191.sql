-- From R, need I, 20191, Liberal Studies: Teacher Education, AA, 'ARTH 20', 'DNCE 12', 'HIST 1', 'HIST 10', 'MUS 1', 'MUS 20', 'TA 20', 'TA 27', 'COMM 1', 'COMM 2', 'COMM 3', 'PHIL 3', 'RD 174', 'WR 1', 'WR 1 H', 'ENG 1 A', 'ENG 1 AH', 'WR 2', 'WR 2 H', 'ENG 1 B', 'ENG 1 BH', 'LIT 1', 'LIT 7', 'LIT 20', 'LIT 21', 'LIT 22', 'LIT 23', 'CS 6 A', 'MATH 30', 'CS 6 B', 'MATH 31', 'ECON 10', 'MGT 10', 'MATH 2', 'MATH 3 A', 'MATH 3 B', 'MATH 4 A', 'MATH 8', 'MATH 10', 'MATH 11', 'MATH 24', 'MATH 26', 'MATH 124', 'PSYC 10', 'BIO 1', 'ERTH 20', 'GEOL 1', 'PHYS 20', 'GEOG 2', 'GEOG 3', 'HD 7', 'PSYC 7', 'HD 15', 'SOC 15', 'HIST 1', 'HIST 20', 'HIST 21', 'PS 1', 'PSYC 13' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Liberal Studies: Teacher Education' as Award_Name
		, 'AA' as Award_Type
		...
		, sum(case when dc.CourseID in ('ARTH 20', 'DNCE 12', 'HIST 1', 'HIST 10', 'MUS 1', 'MUS 20', 'TA 20', 'TA 27', 'COMM 1', 'COMM 2', 'COMM 3', 'PHIL 3', 'RD 174', 'WR 1', 'WR 1 H', 'ENG 1 A', 'ENG 1 AH', 'WR 2', 'WR 2 H', 'ENG 1 B', 'ENG 1 BH', 'LIT 1', 'LIT 7', 'LIT 20', 'LIT 21', 'LIT 22', 'LIT 23', 'CS 6 A', 'MATH 30', 'CS 6 B', 'MATH 31', 'ECON 10', 'MGT 10', 'MATH 2', 'MATH 3 A', 'MATH 3 B', 'MATH 4 A', 'MATH 8', 'MATH 10', 'MATH 11', 'MATH 24', 'MATH 26', 'MATH 124', 'PSYC 10', 'BIO 1', 'ERTH 20', 'GEOL 1', 'PHYS 20', 'GEOG 2', 'GEOG 3', 'HD 7', 'PSYC 7', 'HD 15', 'SOC 15', 'HIST 1', 'HIST 20', 'HIST 21', 'PS 1', 'PSYC 13') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		...
		, max(case when dc.CourseID in ('ARTH 20', 'DNCE 12', 'HIST 1', 'HIST 10', 'MUS 1', 'MUS 20', 'TA 20', 'TA 27') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_01
		, max(case when dc.CourseID in ('COMM 1', 'COMM 2', 'COMM 3', 'PHIL 3', 'RD 174', 'WR 1', 'WR 1 H', 'ENG 1 A', 'ENG 1 AH', 'WR 2', 'WR 2 H', 'ENG 1 B', 'ENG 1 BH') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_02
		, max(case when dc.CourseID in ('LIT 1', 'LIT 7', 'LIT 20', 'LIT 21', 'LIT 22', 'LIT 23') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_03
		, max(case when dc.CourseID in ('CS 6 A', 'MATH 30', 'CS 6 B', 'MATH 31', 'ECON 10', 'MGT 10', 'MATH 2', 'MATH 3 A', 'MATH 3 B', 'MATH 4 A', 'MATH 8', 'MATH 10', 'MATH 11', 'MATH 24', 'MATH 26', 'MATH 124', 'PSYC 10') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_04
		, max(case when dc.CourseID in ('BIO 1', 'ERTH 20', 'GEOL 1', 'PHYS 20') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_05
		, max(case when dc.CourseID in ('GEOG 2', 'GEOG 3', 'HD 7', 'PSYC 7', 'HD 15', 'SOC 15', 'HIST 1', 'HIST 20', 'HIST 21', 'PS 1', 'PSYC 13') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_06
