-- From R, need I, 20191, Humanities, AA, 'WR 2', 'HUM 1', 'HUM 2', 'HUM 3', 'HUM 4', 'HUM 50' -- 'BLANK', 6 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('WR 2', 'HUM 1', 'HUM 2', 'HUM 3', 'HUM 4', 'HUM 50') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
