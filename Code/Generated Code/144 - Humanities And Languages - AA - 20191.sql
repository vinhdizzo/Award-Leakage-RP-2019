-- From R, need I, 20191, Humanities And Languages, AA, 'CHI 2', 'FR 2', 'FR 3', 'FR 4', 'FR 10', 'HIST 1', 'HIST 2', 'HIST 10', 'HIST 11', 'HIST 20', 'HIST 21', 'HIST 24', 'HIST 33', 'HIST 40', 'HIST 41', 'HIST 51', 'HUM 2', 'HUM 3', 'HUM 4', 'HUM 20', 'HUM 21', 'HUM 22', 'HUM 27', 'HUM 50', 'HUM 70', 'HUM 71', 'HUM 72', 'HUM 73', 'HUM 74', 'JA 2', 'JA 3', 'JA 4', 'JA 10', 'JA 21', 'JA 23', 'JRNL 40', 'LIT 1', 'LIT 20', 'LIT 21', 'LIT 22', 'LIT 23', 'LIT 24', 'LIT 30', 'LIT 31', 'LIT 32', 'LIT 33', 'LIT 40', 'LIT 41', 'LIT 43', 'LIT 46', 'LIT 110', 'PHIL 1', 'PHIL 2', 'PHIL 3', 'PHIL 5', 'PHIL 10', 'PHIL 11', 'RD 174', 'SIGN 22', 'SIGN 23', 'SPAN 2', 'SPAN 3', 'SPAN 4', 'SPAN 10', 'WR 2', 'WR 10', 'WR 11', 'WR 13' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Humanities And Languages' as Award_Name
		, 'AA' as Award_Type
		...
		, sum(case when dc.CourseID in ('CHI 2', 'FR 2', 'FR 3', 'FR 4', 'FR 10', 'HIST 1', 'HIST 2', 'HIST 10', 'HIST 11', 'HIST 20', 'HIST 21', 'HIST 24', 'HIST 33', 'HIST 40', 'HIST 41', 'HIST 51', 'HUM 2', 'HUM 3', 'HUM 4', 'HUM 20', 'HUM 21', 'HUM 22', 'HUM 27', 'HUM 50', 'HUM 70', 'HUM 71', 'HUM 72', 'HUM 73', 'HUM 74', 'JA 2', 'JA 3', 'JA 4', 'JA 10', 'JA 21', 'JA 23', 'JRNL 40', 'LIT 1', 'LIT 20', 'LIT 21', 'LIT 22', 'LIT 23', 'LIT 24', 'LIT 30', 'LIT 31', 'LIT 32', 'LIT 33', 'LIT 40', 'LIT 41', 'LIT 43', 'LIT 46', 'LIT 110', 'PHIL 1', 'PHIL 2', 'PHIL 3', 'PHIL 5', 'PHIL 10', 'PHIL 11', 'RD 174', 'SIGN 22', 'SIGN 23', 'SPAN 2', 'SPAN 3', 'SPAN 4', 'SPAN 10', 'WR 2', 'WR 10', 'WR 11', 'WR 13') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		...
		, max(case when dc.CourseID in ('CHI 2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_01
		, max(case when dc.CourseID in ('FR 2', 'FR 3', 'FR 4', 'FR 10') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_02
		, max(case when dc.CourseID in ('HIST 1', 'HIST 2', 'HIST 10', 'HIST 11', 'HIST 20', 'HIST 21', 'HIST 24', 'HIST 33', 'HIST 40', 'HIST 41', 'HIST 51') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_03
		, max(case when dc.CourseID in ('HUM 2', 'HUM 3', 'HUM 4', 'HUM 20', 'HUM 21', 'HUM 22', 'HUM 27', 'HUM 50', 'HUM 70', 'HUM 71', 'HUM 72', 'HUM 73', 'HUM 74') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_04
		, max(case when dc.CourseID in ('JA 2', 'JA 3', 'JA 4', 'JA 10', 'JA 21', 'JA 23') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_05
		, max(case when dc.CourseID in ('JRNL 40') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_06
		, max(case when dc.CourseID in ('LIT 1', 'LIT 20', 'LIT 21', 'LIT 22', 'LIT 23', 'LIT 24', 'LIT 30', 'LIT 31', 'LIT 32', 'LIT 33', 'LIT 40', 'LIT 41', 'LIT 43', 'LIT 46', 'LIT 110') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_07
		, max(case when dc.CourseID in ('PHIL 1', 'PHIL 2', 'PHIL 3', 'PHIL 5', 'PHIL 10', 'PHIL 11') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_08
		, max(case when dc.CourseID in ('RD 174') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_09
		, max(case when dc.CourseID in ('SIGN 22', 'SIGN 23') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_10
		, max(case when dc.CourseID in ('SPAN 2', 'SPAN 3', 'SPAN 4', 'SPAN 10') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_11
		, max(case when dc.CourseID in ('WR 2', 'WR 10', 'WR 11', 'WR 13') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_12
		from
		(
			select
			ds.BK_StudentID
