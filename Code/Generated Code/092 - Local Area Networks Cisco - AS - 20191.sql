-- From R, need I, 20191, Local Area Networks: Cisco, AS, 'CIM 106', 'CIM 108', 'CIM 160', 'CIM 161', 'CIM 263 .1', 'CIM 181', 'CIM 263 .2', 'CIM 182', 'CIM 263 .3', 'CIM 283', 'CIM 263 .4', 'CIM 284' -- 'BLANK', 8 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('CIM 106', 'CIM 108', 'CIM 160', 'CIM 161', 'CIM 263 .1', 'CIM 181', 'CIM 263 .2', 'CIM 182', 'CIM 263 .3', 'CIM 283', 'CIM 263 .4', 'CIM 284') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
