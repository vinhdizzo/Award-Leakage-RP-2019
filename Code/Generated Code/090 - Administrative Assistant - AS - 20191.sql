-- From R, need I, 20191, Administrative Assistant, AS, 'CIM 107', 'CIM 112 .1', 'CIM 112 .2', 'CIM 115', 'CIM 201 A', 'CIM 201 B', 'CIM 210 .2', 'MGT 104', 'MGT 203' -- 'BLANK', 9 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Administrative Assistant' as Award_Name
		, 'AS' as Award_Type
		...
		, sum(case when dc.CourseID in ('CIM 107', 'CIM 112 .1', 'CIM 112 .2', 'CIM 115', 'CIM 201 A', 'CIM 201 B', 'CIM 210 .2', 'MGT 104', 'MGT 203') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
