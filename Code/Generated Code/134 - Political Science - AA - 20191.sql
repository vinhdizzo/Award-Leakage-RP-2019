-- From R, need I, 20191, Political Science, AA, 'PS 1', 'PS 3', 'PS 4', 'PS 5', 'PS 12', 'PS 14' -- 'BLANK', 6 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('PS 1', 'PS 3', 'PS 4', 'PS 5', 'PS 12', 'PS 14') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('PS 6', 'PS 17', 'PS 41') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
