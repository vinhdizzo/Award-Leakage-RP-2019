-- From R, need I, 20191, Photonics Technology, CV, 'ET 102', 'ET 105', 'LET 205', 'LET 215', 'LET 225', 'LET 235' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Photonics Technology' as Award_Name
		, 'CV' as Award_Type
		...
		, sum(case when dc.CourseID in ('ET 102', 'ET 105', 'LET 205', 'LET 215', 'LET 225', 'LET 235') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
