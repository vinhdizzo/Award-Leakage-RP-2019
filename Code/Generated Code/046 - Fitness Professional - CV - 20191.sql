-- From R, need I, 20191, Fitness Professional, CV, 'KNES 103', 'KNES 104', 'KNES 105', 'KNES 106', 'KNES 215', 'NUT 2' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Fitness Professional' as Award_Name
		, 'CV' as Award_Type
		...
		, sum(case when dc.CourseID in ('KNES 103', 'KNES 104', 'KNES 105', 'KNES 106', 'KNES 215', 'NUT 2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
