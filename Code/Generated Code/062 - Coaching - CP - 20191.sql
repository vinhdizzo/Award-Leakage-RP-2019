-- From R, need I, 20191, Coaching, CP, 'KNES 85', 'KNES 86' -- 'BLANK', 2 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('KNES 85', 'KNES 86') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('KNES 4', 'KNES 5', 'KNES 6') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('KNES 11', 'KNES 2', 'KNES 20', 'KNES 22', 'KNES 23', 'KNES 32', 'KNES 71', 'KNES 72', 'KNES 73', 'KNES 74', 'KNES 76', 'KNES 77', 'KNES 78') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		, sum(case when dc.CourseID in ('HLTH 2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_04
