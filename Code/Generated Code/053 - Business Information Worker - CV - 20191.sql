-- From R, need I, 20191, Business Information Worker, CV, 'CIM 103', 'CIM 107', 'CIM 112 .1', 'CIM 112 .2', 'CIM 201 B', 'CIM 201 C', 'CIM 209', 'CIM 210 .1', 'CIM 210 .2', 'MGT 104', 'MGT 125' -- 'BLANK', 11 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Business Information Worker' as Award_Name
		, 'CV' as Award_Type
		...
		, sum(case when dc.CourseID in ('CIM 103', 'CIM 107', 'CIM 112 .1', 'CIM 112 .2', 'CIM 201 B', 'CIM 201 C', 'CIM 209', 'CIM 210 .1', 'CIM 210 .2', 'MGT 104', 'MGT 125') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
