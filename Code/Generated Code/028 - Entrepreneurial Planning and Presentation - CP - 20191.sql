-- From R, need I, 20191, Entrepreneurial Planning and Presentation, CP, 'ENTR 200', 'ENTR 241', 'ENTR 242' -- 'BLANK', 3 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Entrepreneurial Planning and Presentation' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ENTR 200', 'ENTR 241', 'ENTR 242') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
