-- From R, need I, 20191, Manufacturing Assistant, AS, 'MGT 102', 'MGT 125', 'MGT 168', 'MGT 168', 'MGT 168', 'MGT 203', 'MATH 10' -- 'BLANK', 5 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Manufacturing Assistant' as Award_Name
		, 'AS' as Award_Type
		...
		, sum(case when dc.CourseID in ('MGT 102', 'MGT 125', 'MGT 168', 'MGT 168', 'MGT 168', 'MGT 203', 'MATH 10') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('ACCT 112 .1', 'ACCT 112 .2', 'COMM 1') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
