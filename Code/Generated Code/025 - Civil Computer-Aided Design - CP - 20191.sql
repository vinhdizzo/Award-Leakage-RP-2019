-- From R, need I, 20191, Civil Computer-Aided Design, CP, 'ENGR 21', 'ENGR 23', 'GEOG 1', 'GEOG 1 L', 'GEOG 110', 'MATH 124' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Civil Computer-Aided Design' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ENGR 21', 'ENGR 23', 'GEOG 1', 'GEOG 1 L', 'GEOG 110', 'MATH 124') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
