-- From R, need I, 20191, Laser Technology: Optoelectronics, CP, 'ET 99', 'ET 92', 'LASR 25', 'LASR 215', 'LET 25,LET 215' -- 'BLANK', 4 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Laser Technology: Optoelectronics' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ET 99', 'ET 92', 'LASR 25', 'LASR 215', 'LET 25,LET 215') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
