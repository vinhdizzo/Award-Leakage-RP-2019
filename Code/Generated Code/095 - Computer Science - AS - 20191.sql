-- From R, need I, 20191, Computer Science, AS, 'CS 1', 'CS 1 H' -- 'BLANK', 1 -- 0
...
(
	...
	, max(case when N_Course_02 >= 5 then 0 else 5 - N_Course_02 end) as Gap_Major_Course_02
	...
	(
		...
		, sum(case when dc.CourseID in ('CS 1', 'CS 1 H') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('CS 10', 'CS 37', 'CS 38', 'CS 40 A', 'CS 41') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('CS 6 A', 'CS 6 B', 'CS 30', 'CS 36', 'CS 39', 'CS 40 B', 'CS 50', 'CS 131') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
