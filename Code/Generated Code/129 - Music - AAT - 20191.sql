-- From R, need I, 20191, Music, AAT, 'MUS 3', 'MUS 4', 'MUS 5', 'MUS 6' -- 'BLANK', 4 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('MUS 3', 'MUS 4', 'MUS 5', 'MUS 6') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('MUS 39', 'MUS 40', 'MUS 42', 'MUS 44', 'MUS 46', 'MUS 59') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('MUS 50', 'MUS 51', 'MUS 52', 'MUS 53') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
