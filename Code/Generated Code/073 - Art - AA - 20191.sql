-- From R, need I, 20191, Art, AA, 'ART 40', 'ART 41', 'ART 50', 'ART 80', 'ART 85' -- 'BLANK', 5 -- 0
...
(
	...
	, max(case
		-- certificates
		when a.Award_Type in ('CC', 'CO', 'CP', 'CV') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and N_Course_01 >= 5 and N_Course_02 >= 2 and N_Course_03 >= 2 and N_Course_04 >= 0 and N_Course_05 >= 0 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 2) then 1
		-- degrees
		...
		when a.Award_Type in ('AA', 'AS') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and a.DG_CumulativeUnitsEarnedAsOfBOT >= 60 and (gehist.GE_IGETC = 1 or gehist.GE_CSU = 1 or GE_IVC = 1) and N_Course_01 >= 5 and N_Course_02 >= 2 and N_Course_03 >= 2 and N_Course_04 >= 0 and N_Course_05 >= 0 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 2) then 1
		when a.Award_Type in ('AAT', 'AST') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and a.CSU_CumulativeUnitsEarnedAsOfBOT >= 60 and (gehist.GE_IGETC = 1 or gehist.GE_CSU = 1) and N_Course_01 >= 5 and N_Course_02 >= 2 and N_Course_03 >= 2 and N_Course_04 >= 0 and N_Course_05 >= 0 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 2) then 1 -- no IVC GE
		else 0
		end) as Qualify
	...
	, max(case when N_Course_01 >= 5 and N_Course_02 >= 2 and N_Course_03 >= 2 and N_Course_04 >= 0 and N_Course_05 >= 0 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 2) then 1 else 0 end) as Major_Req_Ind
	, max(5 + 2 + 2 + 0 + 0 + 0 + 0 + 0 + 0 + 0) as Major_Req_N
	, max(case when N_Course_01 >= 5 then 0 else 5 - N_Course_01 end) +
		max(case when N_Course_02 >= 2 then 0 else 2 - N_Course_02 end) +
		...
		max(case 
			when a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 2 then 0
			else 2 - (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12)
			end)
		as Gap_Major_Total
	, max(case when N_Course_01 >= 5 then 0 else 5 - N_Course_01 end) as Gap_Major_Course_01
	, max(case when N_Course_02 >= 2 then 0 else 2 - N_Course_02 end) as Gap_Major_Course_02
	...
	(
		...
		, sum(case when dc.CourseID in ('ART 40', 'ART 41', 'ART 50', 'ART 80', 'ART 85') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('ARTH 4', 'ARTH 25', 'ARTH 26', 'ARTH 27') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('ARTH 4', 'ARTH 22', 'ARTH 23', 'ARTH 24', 'ARTH 25', 'ARTH 26', 'ARTH 27', 'ARTH 28', 'ARTH 29', 'ARTH 30', 'ARTH 31', 'ARTH 32', 'ART 81', 'ART 82', 'ART 85', 'ART 86', 'ART 186', 'ART 195', 'ART 51', 'ART 52', 'ART 53') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
	...
	a.N_Course_10 >= 0
	and
	(a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 2)
	-- and
