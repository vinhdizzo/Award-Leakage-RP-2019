-- From R, need I, 20191, Political Science, AAT, 'PS 1', 'PS 1 H' -- 'BLANK', 1 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Political Science' as Award_Name
		, 'AAT' as Award_Type
		...
		, sum(case when dc.CourseID in ('PS 1', 'PS 1 H') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('PS 4', 'PS 5', 'PS 12', 'PS 12 H', 'PS 14', 'PS 14 H', 'MATH 10', 'PSYC 10', 'PSYC 10 H') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('PS 2', 'PS 6', 'PS 7', 'PS 17', 'PS 21', 'PS 41', 'PS 167') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
