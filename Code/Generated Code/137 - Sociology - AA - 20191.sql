-- From R, need I, 20191, Sociology, AA, 'SOC 1', 'SOC 1 H', 'SOC 2', 'SOC 3', 'SOC 10', 'SOC 20', 'ANTH 2', 'ANTH 2 H' -- 'BLANK', 6 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('SOC 1', 'SOC 1 H', 'SOC 2', 'SOC 3', 'SOC 10', 'SOC 20', 'ANTH 2', 'ANTH 2 H') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
