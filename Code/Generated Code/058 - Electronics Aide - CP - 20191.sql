-- From R, need I, 20191, Electronics Aide, CP, 'ET 99', 'ET 102', 'ET 104', 'ET 105' -- 'BLANK', 4 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Electronics Aide' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ET 99', 'ET 102', 'ET 104', 'ET 105') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
