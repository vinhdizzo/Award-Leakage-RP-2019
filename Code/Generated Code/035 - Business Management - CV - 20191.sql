-- From R, need I, 20191, Business Management, CV, 'ACCT 1 A', 'CS 1', 'MGT 1', 'MGT 104', 'MGT 125', 'MGT 135' -- 'BLANK', 7 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ACCT 1 A', 'CS 1', 'MGT 1', 'MGT 104', 'MGT 125', 'MGT 135') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
