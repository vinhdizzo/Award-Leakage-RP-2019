-- From R, need I, 20191, Theatre Arts, AA, 'TA 20', 'TA 22', 'TA 25', 'TA 25 H' -- 'BLANK', 1 -- 0
...
(
	...
	, max(case
		-- certificates
		when a.Award_Type in ('CC', 'CO', 'CP', 'CV') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and N_Course_01 >= 1 and N_Course_02 >= 1 and N_Course_03 >= 1 and N_Course_04 >= 2 and N_Course_05 >= 1 and N_Course_06 >= 1 and N_Course_07 >= 1 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1
		-- degrees
	...
	, max(case when N_Course_01 >= 1 and N_Course_02 >= 1 and N_Course_03 >= 1 and N_Course_04 >= 2 and N_Course_05 >= 1 and N_Course_06 >= 1 and N_Course_07 >= 1 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1 else 0 end) as Major_Req_Ind
	, max(1 + 1 + 1 + 2 + 1 + 1 + 1 + 0 + 0 + 0) as Major_Req_N
	, max(case when N_Course_01 >= 1 then 0 else 1 - N_Course_01 end) +
		max(case when N_Course_02 >= 1 then 0 else 1 - N_Course_02 end) +
		max(case when N_Course_03 >= 1 then 0 else 1 - N_Course_03 end) +
		max(case when N_Course_04 >= 2 then 0 else 2 - N_Course_04 end) +
		max(case when N_Course_05 >= 1 then 0 else 1 - N_Course_05 end) +
		max(case when N_Course_06 >= 1 then 0 else 1 - N_Course_06 end) +
		max(case when N_Course_07 >= 1 then 0 else 1 - N_Course_07 end) +
		...
		as Gap_Major_Total
	, max(case when N_Course_01 >= 1 then 0 else 1 - N_Course_01 end) as Gap_Major_Course_01
	, max(case when N_Course_02 >= 1 then 0 else 1 - N_Course_02 end) as Gap_Major_Course_02
	, max(case when N_Course_03 >= 1 then 0 else 1 - N_Course_03 end) as Gap_Major_Course_03
	, max(case when N_Course_04 >= 2 then 0 else 2 - N_Course_04 end) as Gap_Major_Course_04
	, max(case when N_Course_05 >= 1 then 0 else 1 - N_Course_05 end) as Gap_Major_Course_05
	, max(case when N_Course_06 >= 1 then 0 else 1 - N_Course_06 end) as Gap_Major_Course_06
	, max(case when N_Course_07 >= 1 then 0 else 1 - N_Course_07 end) as Gap_Major_Course_07
	...
	(
		...
		, sum(case when dc.CourseID in ('TA 20', 'TA 22', 'TA 25', 'TA 25 H') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('TA 21', 'TA 26', 'TA 26 H') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('TA 1', 'TA 8', 'TA 12') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		, sum(case when dc.CourseID in ('TA 15', 'TA 15 A', 'TA 15 B', 'TA 16', 'TA 16 A', 'TA 16 B', 'TA 17', 'TA 17 A', 'TA 17 B', 'TA 18', 'TA 18 A', 'TA 18 B', 'TA 19', 'TA 19 A', 'TA 19 B') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_04
		, sum(case when dc.CourseID in ('TA 51', 'TA 53', 'TA 61', 'TA 62', 'TA 63', 'TA 64') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_05
		, sum(case when dc.CourseID in ('TA 44', 'TA 45', 'TA 71', 'TA 72', 'TA 73', 'TA 74', 'TA 75', 'TA 76') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_06
		, sum(case when dc.CourseID in ('TA 2', 'TA 3', 'TA 7', 'TA 9', 'TA 10', 'TA 29', 'TA 29 H', 'TA 35', 'TA 40', 'TA 41', 'TA 42', 'TA 43', 'TA 46', 'TA 47', 'TA 49', 'TA 2', 'TA 65', 'TA 72', 'TA 75') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_07
