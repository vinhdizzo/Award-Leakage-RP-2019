-- From R, need I, 20191, Theatre Arts, AAT, 'TA 22', 'TA 25', 'TA 25 H' -- 'BLANK', 1 -- 0
...
(
	...
	, max(case
		-- certificates
		when a.Award_Type in ('CC', 'CO', 'CP', 'CV') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and N_Course_01 >= 1 and N_Course_02 >= 1 and N_Course_03 >= 2 and N_Course_04 >= 3 and N_Course_05 >= 2 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1
		-- degrees
	...
	, max(case when N_Course_01 >= 1 then 0 else 1 - N_Course_01 end) +
		...
		max(case when N_Course_04 >= 3 then 0 else 3 - N_Course_04 end) +
	...
	, max(case when N_Course_04 >= 3 then 0 else 3 - N_Course_04 end) as Gap_Major_Course_04
	...
	(
		...
		, sum(case when dc.CourseID in ('TA 22', 'TA 25', 'TA 25 H') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('TA 1', 'TA 2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('TA 15', 'TA 15 A', 'TA 15 B', 'TA 16', 'TA 16 A', 'TA 16 B', 'TA 17', 'TA 17 A', 'TA 17 B', 'TA 18', 'TA 18 A', 'TA 18 B', 'TA 19', 'TA 19 A', 'TA 19 B', 'TA 142 C', 'TA 141 A', 'TA 141 B', 'TA 141 C', 'TA 141 D', 'TA 141 E', 'TA 48 B', 'TA 141 E') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		, sum(case when dc.CourseID in ('TA 8', 'TA 40', 'TA 41', 'TA 42', 'TA 44', 'TA 49') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_04
		, sum(case when dc.CourseID in ('TA 15', 'TA 15 A', 'TA 15 B', 'TA 16', 'TA 16 A', 'TA 16 B', 'TA 17', 'TA 17 A', 'TA 17 B', 'TA 19', 'TA 19 A', 'TA 19 B', 'TA 142 C', 'TA 141 A', 'TA 141 B', 'TA 141 C', 'TA 141 D', 'TA 141 E', 'TA 48 B', 'TA 48 C') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_05
