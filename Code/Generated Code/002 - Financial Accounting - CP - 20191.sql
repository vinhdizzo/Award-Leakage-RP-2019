-- From R, need I, 20191, Financial Accounting, CP, 'ACCT 1 A', 'ACCT 112 .1', 'ACCT 112 .2' -- 'BLANK', 3 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Financial Accounting' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ACCT 1 A', 'ACCT 112 .1', 'ACCT 112 .2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
