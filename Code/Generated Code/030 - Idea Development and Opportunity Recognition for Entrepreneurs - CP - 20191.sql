-- From R, need I, 20191, Idea Development and Opportunity Recognition for Entrepreneurs, CP, 'ENTR 200', 'ENTR 201', 'ENTR 202' -- 'BLANK', 3 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Idea Development and Opportunity Recognition for Entrepreneurs' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ENTR 200', 'ENTR 201', 'ENTR 202') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
