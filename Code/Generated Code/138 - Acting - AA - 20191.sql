-- From R, need I, 20191, Acting, AA, 'TA 1', 'TA 2' -- 'BLANK', 2 -- 0
...
(
	...
	, max(case
		-- certificates
		when a.Award_Type in ('CC', 'CO', 'CP', 'CV') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and N_Course_01 >= 2 and N_Course_02 >= 1 and N_Course_03 >= 1 and N_Course_04 >= 2 and N_Course_05 >= 1 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1
		-- degrees
	...
	, max(case when N_Course_01 >= 2 and N_Course_02 >= 1 and N_Course_03 >= 1 and N_Course_04 >= 2 and N_Course_05 >= 1 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1 else 0 end) as Major_Req_Ind
	, max(2 + 1 + 1 + 2 + 1 + 0 + 0 + 0 + 0 + 0) as Major_Req_N
	, max(case when N_Course_01 >= 2 then 0 else 2 - N_Course_01 end) +
		...
		as Gap_Major_Total
	, max(case when N_Course_01 >= 2 then 0 else 2 - N_Course_01 end) as Gap_Major_Course_01
	...
	(
		...
		, sum(case when dc.CourseID in ('TA 1', 'TA 2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('TA 3', 'TA 4', 'TA 5') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('TA 20', 'TA 25', 'TA 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		, sum(case when dc.CourseID in ('TA 15', 'TA 15 A', 'TA 15 B', 'TA 16', 'TA 16 A', 'TA 16 B', 'TA 17', 'TA 17 A', 'TA 17 B', 'TA 18', 'TA 18 A', 'TA 18 B', 'TA 19', 'TA 19 A', 'TA 19 B', 'TA 241 A', 'TA 241 B', 'TA 241 C') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_04
		, sum(case when dc.CourseID in ('TA 40', 'TA 40 C', 'TA 41', 'TA 42') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_05
