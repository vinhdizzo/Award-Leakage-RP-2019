-- From R, need I, 20191, Mechanical Computer-Aided Design, CP, 'DR 50', 'DR 101', 'ENGR 21', 'ENGR 54', 'ENGR 83', 'MATH 124' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Mechanical Computer-Aided Design' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('DR 50', 'DR 101', 'ENGR 21', 'ENGR 54', 'ENGR 83', 'MATH 124') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
