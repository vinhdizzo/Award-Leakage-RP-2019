-- From R, need I, 20191, Mathematics, AST, 'MATH 3 A', 'MATH 3 AH', 'MATH 3 B', 'MATH 3 BH', 'MATH 4 A' -- 'BLANK', 3 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('MATH 3 A', 'MATH 3 AH', 'MATH 3 B', 'MATH 3 BH', 'MATH 4 A') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('MATH 24', 'MATH 24 H', 'MATH 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('CS 6 B', 'MATH 31', 'CS 30', 'CS 36', 'CS 37', 'CS 38', 'CS 40 A', 'CS 40 B', 'CS 41', 'CS 130', 'MATH 10', 'PHYS 4 A') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
