-- From R, need I, 20191, Real Estate, CV, 'RE 172', 'RE 174 A', 'RE 175', 'RE 176 A' -- 'BLANK', 4 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ECON 1', 'ECON 2', 'ECON 13', 'ECON 20', 'ACCT 1 A', 'ACCT 1 B', 'ACCT 204', 'ACCT 215') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('RE 170', 'RE 190', 'RE 195', 'RE 250', 'MGT 12 A') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
