-- From R, need I, 20191, Geology, AST, 'GEOL 1', 'GEOL 2', 'CHEM 1 A', 'CHEM 1 B', 'MATH 3 A', 'MATH 3 AH', 'MATH 3 B', 'MATH 3 BH' -- 'BLANK', 6 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('GEOL 1', 'GEOL 2', 'CHEM 1 A', 'CHEM 1 B', 'MATH 3 A', 'MATH 3 AH', 'MATH 3 B', 'MATH 3 BH') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
