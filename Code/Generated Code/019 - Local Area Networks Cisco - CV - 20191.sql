-- From R, need I, 20191, Local Area Networks: Cisco, CV, 'CIM 110', 'CIM 106', 'CIM 108', 'CIM 160', 'CIM 161', 'CIM 181', 'CIM 182', 'CIM 284', 'CIM 284' -- 'BLANK', 7 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Local Area Networks: Cisco' as Award_Name
		, 'CV' as Award_Type
		...
		, sum(case when dc.CourseID in ('CIM 110', 'CIM 106', 'CIM 108', 'CIM 160', 'CIM 161', 'CIM 181', 'CIM 182', 'CIM 284', 'CIM 284') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
