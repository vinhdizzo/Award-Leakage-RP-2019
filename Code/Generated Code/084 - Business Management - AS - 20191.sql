-- From R, need I, 20191, Business Management, AS, 'ACCT 1 A', 'CS 1', 'CS 1 H', 'MGT 1', 'MGT 12 A', 'MGT 104', 'MGT 125', 'MGT 135' -- 'BLANK', 7 -- 0
...
(
	...
	, max(case when N_Course_01 >= 7 and N_Course_02 >= 0 and N_Course_03 >= 0 and N_Course_04 >= 0 and N_Course_05 >= 0 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1 else 0 end) as Major_Req_Ind
	, max(7 + 0 + 0 + 0 + 0 + 0 + 0 + 0 + 0 + 0) as Major_Req_N
	, max(case when N_Course_01 >= 7 then 0 else 7 - N_Course_01 end) +
		...
		as Gap_Major_Total
	, max(case when N_Course_01 >= 7 then 0 else 7 - N_Course_01 end) as Gap_Major_Course_01
	...
	(
		select
		cur_stud.*
		, 'Business Management' as Award_Name
		, 'AS' as Award_Type
		...
		, sum(case when dc.CourseID in ('ACCT 1 A', 'CS 1', 'CS 1 H', 'MGT 1', 'MGT 12 A', 'MGT 104', 'MGT 125', 'MGT 135') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
