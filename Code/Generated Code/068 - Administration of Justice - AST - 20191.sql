-- From R, need I, 20191, Administration of Justice, AST, 'AJ 2', 'AJ 4' -- 'BLANK', 2 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Administration of Justice' as Award_Name
		, 'AST' as Award_Type
		...
		, sum(case when dc.CourseID in ('AJ 2', 'AJ 4') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('AJ 5', 'AJ 8', 'AJ 19', 'AJ 105') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('AJ 5', 'AJ 8', 'AJ 13', 'AJ 19', 'AJ 61', 'AJ 105', 'AJ 106', 'AJ 111', 'AJ 112', 'AJ 150', 'MATH 10', 'PSYC 1', 'PSYC 1 H', 'PSYC 10', 'PSYC 10 H', 'SOC 1', 'SOC 1 H') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
