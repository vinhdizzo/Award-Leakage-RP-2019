-- From R, need I, 20191, Piano Pedagogy, CP, 'MUS 255', 'MUS 256' -- 'BLANK', 2 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('MUS 255', 'MUS 256') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('MUS 59', 'MUS 65', 'MUS 51', 'MUS 53', 'MUS 62', 'ENTR 200', 'PSYC 7') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
