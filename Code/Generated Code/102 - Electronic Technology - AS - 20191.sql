-- From R, need I, 20191, Electronic Technology, AS, 'ET 99', 'ET 102', 'ET 104', 'ET 105', 'ET 107' -- 'BLANK', 5 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Electronic Technology' as Award_Name
		, 'AS' as Award_Type
		...
		, sum(case when dc.CourseID in ('ET 99', 'ET 102', 'ET 104', 'ET 105', 'ET 107') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('ET 116', 'ET 119', 'ET 120', 'ET 122 A', 'ET 122 B', 'ET 168') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
