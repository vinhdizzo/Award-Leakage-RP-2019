-- From R, need I, 20191, Studio Arts, AAT, 'ART 20', 'ART 41', 'ART 80', 'ARTH 26' -- 'BLANK', 4 -- 0
...
(
	...
	, sum(case when dam.BK_CollegeCode=@CoR and dam.BK_AwardTypeCode='AAT' and dam.AwardMajorDesc=a.Award_Name then 1 else 0 end) as Award_Activity
	, max(case when N_Course_01 >= 4 and N_Course_02 >= 1 and N_Course_03 >= 3 and N_Course_04 >= 0 and N_Course_05 >= 0 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 3) then 1 else 0 end) as Major_Req_Ind
	, max(4 + 1 + 3 + 0 + 0 + 0 + 0 + 0 + 0 + 0) as Major_Req_N
	, max(case when N_Course_01 >= 4 then 0 else 4 - N_Course_01 end) +
		max(case when N_Course_02 >= 1 then 0 else 1 - N_Course_02 end) +
		max(case when N_Course_03 >= 3 then 0 else 3 - N_Course_03 end) +
		...
		as Gap_Major_Total
	, max(case when N_Course_01 >= 4 then 0 else 4 - N_Course_01 end) as Gap_Major_Course_01
	, max(case when N_Course_02 >= 1 then 0 else 1 - N_Course_02 end) as Gap_Major_Course_02
	, max(case when N_Course_03 >= 3 then 0 else 3 - N_Course_03 end) as Gap_Major_Course_03
	...
	(
		...
		, sum(case when dc.CourseID in ('ART 20', 'ART 41', 'ART 80', 'ARTH 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('ARTH 22', 'ARTH 23', 'ARTH 25') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('ART 81', 'ART 85', 'ART 86', 'ART 50', 'ART 60', 'DMA 55', 'ART 51', 'ART 65') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		...
		, max(case when dc.CourseID in ('ART 81', 'ART 85', 'ART 86') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_01
		, max(case when dc.CourseID in ('ART 50') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_02
		, max(case when dc.CourseID in ('ART 60') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_03
		, max(case when dc.CourseID in ('DMA 55') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_04
		, max(case when dc.CourseID in ('ART 51', 'DMA 65') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_05
