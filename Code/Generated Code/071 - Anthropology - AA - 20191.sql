-- From R, need I, 20191, Anthropology, AA, 'ANTH 1', 'ANTH 1 H', 'ANTH 2', 'ANTH 2 H', 'ANTH 3', 'ANTH 9' -- 'BLANK', 4 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ANTH 1 L', 'ANTH 4', 'ANTH 7', 'ANTH 13', 'PSYC 1', 'PSYC 1 H', 'SOC 1', 'SOC 1 H') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
