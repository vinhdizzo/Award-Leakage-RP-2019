-- From R, need I, 20191, Japanese, AA, 'JA 1', 'JA 1 H', 'JA 2', 'JA 3', 'JA 4', 'JA 10' -- 'BLANK', 5 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('JA 1', 'JA 1 H', 'JA 2', 'JA 3', 'JA 4', 'JA 10') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
