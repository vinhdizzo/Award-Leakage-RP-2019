-- From R, need I, 20191, Physics, AST, 'PHYS 4 A', 'PHYS 4 B', 'PHYS 4 C', 'MATH 3 A', 'MATH 3 AH', 'MATH 3 B', 'MATH 3 BH', 'MATH 4 A' -- 'BLANK', 6 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('PHYS 4 A', 'PHYS 4 B', 'PHYS 4 C', 'MATH 3 A', 'MATH 3 AH', 'MATH 3 B', 'MATH 3 BH', 'MATH 4 A') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
