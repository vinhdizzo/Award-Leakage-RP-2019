-- From R, need I, 20191, Immersive Design - 2D Animation, CP, 'ART 85', 'IMA 20', 'IMA 96', 'IMA 193' -- 'BLANK', 4 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Immersive Design - 2D Animation' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ART 85', 'IMA 20', 'IMA 96', 'IMA 193') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
