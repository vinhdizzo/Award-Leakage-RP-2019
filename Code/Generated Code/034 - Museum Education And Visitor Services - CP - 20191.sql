-- From R, need I, 20191, Museum Education And Visitor Services, CP, 'ARTH 110', 'ARTH 125', 'COMM 1' -- 'BLANK', 3 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Museum Education And Visitor Services' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ARTH 110', 'ARTH 125', 'COMM 1') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
