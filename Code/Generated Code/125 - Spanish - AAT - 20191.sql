-- From R, need I, 20191, Spanish, AAT, 'SPAN 1', 'SPAN 1 H', 'SPAN 2', 'SPAN 3', 'SPAN 4' -- 'BLANK', 4 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('SPAN 1', 'SPAN 1 H', 'SPAN 2', 'SPAN 3', 'SPAN 4') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('SPAN 10', 'SPAN 11', 'FR 1', 'FR 1 H', 'FR 2', 'FR 3', 'FR 4') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
