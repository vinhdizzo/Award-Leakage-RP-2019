-- From R, need I, 20191, Kinesiology, AAT, 'BIO 11', 'BIO 12', 'KNES 12' -- 'BLANK', 3 -- 0
...
(
	...
	, max(case when N_Course_03 >= 2 then 0 else 2 - N_Course_03 end) as Gap_Major_Course_03
	...
	(
		...
		, sum(case when dc.CourseID in ('BIO 11', 'BIO 12', 'KNES 12') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		...
		, sum(case when dc.CourseID in ('ECON 10', 'PSYC 10', 'MATH 10', 'BIO 1', 'BIO 1 L', 'CHEM 1 A', 'CHEM 4', 'PHYS 2 A', 'PHYS 4 B', 'HLTH 2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		...
		, max(case when dc.CourseID in ('DNCE 1', 'DNCE 6', 'DNCE 7', 'DNCE 12', 'DNCE 13', 'DNCE 17', 'DNCE 17 A', 'DNCE 17 B', 'DNCE 18', 'DNCE 18 A', 'DNCE 18 B', 'DNCE 22', 'DNCE 23', 'DNCE 27', 'DNCE 33', 'DNCE 34', 'DNCE 36', 'DNCE 46', 'DNCE 47', 'DNCE 51', 'DNCE 51 A', 'DNCE 51 B') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_01
		, max(case when dc.CourseID in ('KNES 3 A', 'KNES 3 B', 'KNES 3 C', 'KNES 4', 'KNES 5') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_02
		, max(case when dc.CourseID in ('IA 6', 'IA 7', 'IA 9', 'IA 13', 'KNES 11', 'KNES 12', 'KNES 20', 'KNES 22', 'KNES 23', 'KNES 25', 'KNES 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_03
		, max(case when dc.CourseID in ('IA 2', 'IA 3', 'IA 10', 'IA 12', 'IA 15', 'IA 18', 'IA 19', 'KNES 63', 'KNES 73', 'KNES 76', 'KNES 77', 'KNES 78', 'KNES 83') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_04
