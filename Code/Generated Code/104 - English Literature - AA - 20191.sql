-- From R, need I, 20191, English: Literature, AA, 'WR 2', 'WR 2 H', 'LIT 1', 'LIT 46' -- 'BLANK', 3 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'English: Literature' as Award_Name
		, 'AA' as Award_Type
		...
		, sum(case when dc.CourseID in ('WR 2', 'WR 2 H', 'LIT 1', 'LIT 46') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
