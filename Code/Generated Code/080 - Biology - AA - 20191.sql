-- From R, need I, 20191, Biology, AA, 'BIO 93', 'BIO 81', 'BIO 94', 'BIO 80', 'BIO 97', 'BIO 99' -- 'BLANK', 4 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('BIO 93', 'BIO 81', 'BIO 94', 'BIO 80', 'BIO 97', 'BIO 99') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('BIO 11', 'BIO 12', 'BIO 13', 'BIO 15', 'BIO 19', 'BIO 19 H', 'BIO 30', 'BIO 44', 'BIO 55', 'CHEM 1 A', 'CHEM 1 B', 'CHEM 12 A', 'CHEM 12 B') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
