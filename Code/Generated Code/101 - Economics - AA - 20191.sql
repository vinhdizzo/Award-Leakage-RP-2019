-- From R, need I, 20191, Economics, AA, 'ECON 1', 'ECON 1 H', 'ECON 2', 'ECON 2 H', 'ECON 6', 'ECON 10', 'ECON 13' -- 'BLANK', 5 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ECON 1', 'ECON 1 H', 'ECON 2', 'ECON 2 H', 'ECON 6', 'ECON 10', 'ECON 13') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('MATH 3 A', 'MATH 3 AH', 'MATH 11') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('ACCT 1 A', 'CS 1', 'CS 1 H', 'ECON 105', 'MATH 3 B', 'MATH 3 BH') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
