-- From R, need I, 20191, Administration Of Justice: Supervision, AS, 'AJ 4', 'AJ 106', 'AJ 111', 'AJ 112', 'AJ 150', 'PSYC 1' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Administration Of Justice: Supervision' as Award_Name
		, 'AS' as Award_Type
		...
		, sum(case when dc.CourseID in ('AJ 4', 'AJ 106', 'AJ 111', 'AJ 112', 'AJ 150', 'PSYC 1') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('AJ 5', 'AJ 8', 'AJ 102', 'AJ 103', 'AJ 105', 'AJ 107', 'AJ 161', 'AJ 168') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
