-- From R, need I, 20191, Administration Of Justice: Law Enforcement Emphasis, AS, 'AJ 2', 'AJ 4', 'AJ 5', 'AJ 150' -- 'BLANK', 4 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Administration Of Justice: Law Enforcement Emphasis' as Award_Name
		, 'AS' as Award_Type
		...
		, sum(case when dc.CourseID in ('AJ 2', 'AJ 4', 'AJ 5', 'AJ 150') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('AJ 8', 'AJ 105', 'AJ 106', 'AJ 111', 'AJ 112', 'AJ 113', 'AJ 119', 'AJ 161', 'AJ 250', 'AJ 168') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
