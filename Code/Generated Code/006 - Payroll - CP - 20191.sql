-- From R, need I, 20191, Payroll, CP, 'ACCT 1 A', 'ACCT 205', 'ACCT 112 .1', 'ACCT 112 .2' -- 'BLANK', 4 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ACCT 1 A', 'ACCT 205', 'ACCT 112 .1', 'ACCT 112 .2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
