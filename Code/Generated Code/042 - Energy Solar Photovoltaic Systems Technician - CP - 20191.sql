-- From R, need I, 20191, Energy Solar Photovoltaic Systems Technician, CP, 'ELEC 200', 'ELEC 201', 'ELEC 211', 'ELEC 212' -- 'BLANK', 4 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Energy Solar Photovoltaic Systems Technician' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ELEC 200', 'ELEC 201', 'ELEC 211', 'ELEC 212') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
