-- From R, need I, 20191, Curatorial Studies, CP, 'ARTH 110', 'ARTH 115', 'ARTH 120' -- 'BLANK', 3 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Curatorial Studies' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ARTH 110', 'ARTH 115', 'ARTH 120') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
