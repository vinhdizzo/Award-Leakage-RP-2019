-- From R, need I, 20191, Electrician Trainee, CP, 'ET 102', 'ET 104', 'ELEC 200 A', 'ELEC 201', 'ELEC 203' -- 'BLANK', 5 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Electrician Trainee' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ET 102', 'ET 104', 'ELEC 200 A', 'ELEC 201', 'ELEC 203') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
