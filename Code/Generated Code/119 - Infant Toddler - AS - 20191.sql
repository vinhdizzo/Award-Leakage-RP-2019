-- From R, need I, 20191, Infant Toddler, AS, 'HD 7', 'HD 15', 'HD 104', 'HD 105', 'HD 120', 'HD 131', 'HD 145', 'HD 150', 'HD 168' -- 'BLANK', 9 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('HD 7', 'HD 15', 'HD 104', 'HD 105', 'HD 120', 'HD 131', 'HD 145', 'HD 150', 'HD 168') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
