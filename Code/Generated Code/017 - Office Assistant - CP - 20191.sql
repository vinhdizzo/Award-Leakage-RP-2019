-- From R, need I, 20191, Office Assistant, CP, 'CIM 107', 'CIM 112 .1', 'CIM 201 A', 'CIM 201 B', 'CIM 210 .2', 'MGT 203' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Office Assistant' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('CIM 107', 'CIM 112 .1', 'CIM 201 A', 'CIM 201 B', 'CIM 210 .2', 'MGT 203') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
