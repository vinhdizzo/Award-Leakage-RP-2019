-- From R, need I, 20191, Fine Arts Appreciation, AA, 'DMA 51', 'DMA 55', 'DMA 120', 'DMA 130', 'DMA 140', 'DMA 195', 'PHOT 51', 'DNCE 1', 'DNCE 1 A', 'DNCE 1 B', 'DNCE 6', 'DNCE 7', 'DNCE 12', 'DNCE 13', 'DNCE 17', 'DNCE 17 A', 'DNCE 17 B', 'DNCE 18', 'DNCE 18 A', 'DNCE 18 B', 'DNCE 22', 'DNCE 23', 'DNCE 27', 'DNCE 33', 'DNCE 34', 'DNCE 65', 'DNCE 142', 'DNCE 170', 'COMM 1', 'COMM 30', 'TA 30', 'COMM 106 A', 'COMM 106 B', 'COMM 106 C', 'MUS 39', 'MUS 40', 'MUS 42', 'MUS 46', 'MUS 54', 'MUS 55', 'MUS 56', 'MUS 57', 'MUS 80', 'MUS 81', 'MUS 82', 'MUS 85', 'ART 40', 'ART 41', 'ART 50', 'ART 51', 'ART 52', 'ART 80', 'ART 81', 'ART 85', 'ART 86', 'ART 186', 'ART 195', 'TA 15', 'TA 15 A', 'TA 15 B', 'TA 16', 'TA 16 A', 'TA 16 B', 'TA 17', 'TA 17 A', 'TA 17 B', 'TA 18', 'TA 18 A', 'TA 18 B', 'TA 19', 'TA 19 A', 'TA 19 B', 'TA 40', 'ARTH 1', 'ARTH 4', 'ARTH 20', 'ARTH 22', 'ARTH 23', 'ARTH 24', 'ARTH 25', 'ARTH 26', 'ARTH 27', 'ARTH 28', 'ARTH 29', 'ARTH 30', 'ARTH 104', 'ARTH 110', 'ARTH 115', 'ARTH 130', 'ARTH 150', 'DNCE 55', 'DNCE 77', 'DNCE 85', 'MUS 1', 'MUS 3', 'MUS 20', 'MUS 21', 'MUS 27', 'MUS 28', 'TA 20', 'TA 21', 'TA 25', 'TA 26' -- 'BLANK', 6 -- 0
...
(
	...
	, max(case
		-- certificates
		when a.Award_Type in ('CC', 'CO', 'CP', 'CV') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and N_Course_01 >= 6 and N_Course_02 >= 0 and N_Course_03 >= 0 and N_Course_04 >= 0 and N_Course_05 >= 0 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 3) then 1
		-- degrees
		...
		when a.Award_Type in ('AA', 'AS') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and a.DG_CumulativeUnitsEarnedAsOfBOT >= 60 and (gehist.GE_IGETC = 1 or gehist.GE_CSU = 1 or GE_IVC = 1) and N_Course_01 >= 6 and N_Course_02 >= 0 and N_Course_03 >= 0 and N_Course_04 >= 0 and N_Course_05 >= 0 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 3) then 1
		when a.Award_Type in ('AAT', 'AST') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and a.CSU_CumulativeUnitsEarnedAsOfBOT >= 60 and (gehist.GE_IGETC = 1 or gehist.GE_CSU = 1) and N_Course_01 >= 6 and N_Course_02 >= 0 and N_Course_03 >= 0 and N_Course_04 >= 0 and N_Course_05 >= 0 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 3) then 1 -- no IVC GE
		else 0
		end) as Qualify
	...
	, sum(case when dam.BK_CollegeCode=@CoR and dam.BK_AwardTypeCode='AA' and dam.AwardMajorDesc=a.Award_Name then 1 else 0 end) as Award_Activity
	, max(case when N_Course_01 >= 6 and N_Course_02 >= 0 and N_Course_03 >= 0 and N_Course_04 >= 0 and N_Course_05 >= 0 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 3) then 1 else 0 end) as Major_Req_Ind
	, max(6 + 0 + 0 + 0 + 0 + 0 + 0 + 0 + 0 + 0) as Major_Req_N
	, max(case when N_Course_01 >= 6 then 0 else 6 - N_Course_01 end) +
		...
		max(case 
			when a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 3 then 0
			else 3 - (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12)
			end)
		as Gap_Major_Total
	, max(case when N_Course_01 >= 6 then 0 else 6 - N_Course_01 end) as Gap_Major_Course_01
	...
	(
		select
		cur_stud.*
		, 'Fine Arts Appreciation' as Award_Name
		, 'AA' as Award_Type
		...
		, sum(case when dc.CourseID in ('DMA 51', 'DMA 55', 'DMA 120', 'DMA 130', 'DMA 140', 'DMA 195', 'PHOT 51', 'DNCE 1', 'DNCE 1 A', 'DNCE 1 B', 'DNCE 6', 'DNCE 7', 'DNCE 12', 'DNCE 13', 'DNCE 17', 'DNCE 17 A', 'DNCE 17 B', 'DNCE 18', 'DNCE 18 A', 'DNCE 18 B', 'DNCE 22', 'DNCE 23', 'DNCE 27', 'DNCE 33', 'DNCE 34', 'DNCE 65', 'DNCE 142', 'DNCE 170', 'COMM 1', 'COMM 30', 'TA 30', 'COMM 106 A', 'COMM 106 B', 'COMM 106 C', 'MUS 39', 'MUS 40', 'MUS 42', 'MUS 46', 'MUS 54', 'MUS 55', 'MUS 56', 'MUS 57', 'MUS 80', 'MUS 81', 'MUS 82', 'MUS 85', 'ART 40', 'ART 41', 'ART 50', 'ART 51', 'ART 52', 'ART 80', 'ART 81', 'ART 85', 'ART 86', 'ART 186', 'ART 195', 'TA 15', 'TA 15 A', 'TA 15 B', 'TA 16', 'TA 16 A', 'TA 16 B', 'TA 17', 'TA 17 A', 'TA 17 B', 'TA 18', 'TA 18 A', 'TA 18 B', 'TA 19', 'TA 19 A', 'TA 19 B', 'TA 40', 'ARTH 1', 'ARTH 4', 'ARTH 20', 'ARTH 22', 'ARTH 23', 'ARTH 24', 'ARTH 25', 'ARTH 26', 'ARTH 27', 'ARTH 28', 'ARTH 29', 'ARTH 30', 'ARTH 104', 'ARTH 110', 'ARTH 115', 'ARTH 130', 'ARTH 150', 'DNCE 55', 'DNCE 77', 'DNCE 85', 'MUS 1', 'MUS 3', 'MUS 20', 'MUS 21', 'MUS 27', 'MUS 28', 'TA 20', 'TA 21', 'TA 25', 'TA 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		...
		, max(case when dc.CourseID in ('DMA 51', 'DMA 55', 'DMA 120', 'DMA 130', 'DMA 140', 'DMA 195', 'PHOT 51') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_01
		, max(case when dc.CourseID in ('DNCE 1', 'DNCE 1 A', 'DNCE 1 B', 'DNCE 6', 'DNCE 7', 'DNCE 12', 'DNCE 13', 'DNCE 17', 'DNCE 17 A', 'DNCE 17 B', 'DNCE 18', 'DNCE 18 A', 'DNCE 18 B', 'DNCE 22', 'DNCE 23', 'DNCE 27', 'DNCE 33', 'DNCE 34', 'DNCE 65', 'DNCE 142', 'DNCE 170') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_02
		, max(case when dc.CourseID in ('COMM 1', 'COMM 30', 'TA 30', 'COMM 106 A', 'COMM 106 B', 'COMM 106 C') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_03
		, max(case when dc.CourseID in ('MUS 39', 'MUS 40', 'MUS 42', 'MUS 46', 'MUS 54', 'MUS 55', 'MUS 56', 'MUS 57', 'MUS 80', 'MUS 81', 'MUS 82', 'MUS 85') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_04
		, max(case when dc.CourseID in ('ART 40', 'ART 41', 'ART 50', 'ART 51', 'ART 52', 'ART 80', 'ART 81', 'ART 85', 'ART 86', 'ART 186', 'ART 195') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_05
		, max(case when dc.CourseID in ('TA 15', 'TA 15 A', 'TA 15 B', 'TA 16', 'TA 16 A', 'TA 16 B', 'TA 17', 'TA 17 A', 'TA 17 B', 'TA 18', 'TA 18 A', 'TA 18 B', 'TA 19', 'TA 19 A', 'TA 19 B', 'TA 40') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_06
		, max(case when dc.CourseID in ('ARTH 1', 'ARTH 4', 'ARTH 20', 'ARTH 22', 'ARTH 23', 'ARTH 24', 'ARTH 25', 'ARTH 26', 'ARTH 27', 'ARTH 28', 'ARTH 29', 'ARTH 30', 'ARTH 104', 'ARTH 110', 'ARTH 115', 'ARTH 130', 'ARTH 150') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_07
		, max(case when dc.CourseID in ('DNCE 55', 'DNCE 77', 'DNCE 85') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_08
		, max(case when dc.CourseID in ('MUS 1', 'MUS 3', 'MUS 20', 'MUS 21', 'MUS 27', 'MUS 28') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_09
		, max(case when dc.CourseID in ('TA 20', 'TA 21', 'TA 25', 'TA 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_10
	...
	a.N_Course_10 >= 0
	and
	(a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 3)
	-- and
