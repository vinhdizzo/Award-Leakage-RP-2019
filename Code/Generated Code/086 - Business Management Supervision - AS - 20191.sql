-- From R, need I, 20191, Business Management: Supervision, AS, 'CIM 112 .1', 'CIM 201 A', 'ENTR 217', 'MGT 1', 'MGT 104', 'MGT 125', 'MGT 203', 'COMM 1', 'MGT 102' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Business Management: Supervision' as Award_Name
		, 'AS' as Award_Type
		...
		, sum(case when dc.CourseID in ('CIM 112 .1', 'CIM 201 A', 'ENTR 217', 'MGT 1', 'MGT 104', 'MGT 125', 'MGT 203', 'COMM 1', 'MGT 102') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
