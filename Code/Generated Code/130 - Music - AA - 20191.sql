-- From R, need I, 20191, Music, AA, 'MUS 54', 'MUS 55' -- 'BLANK', 2 -- 0
...
(
	...
	, max(case
		-- certificates
		when a.Award_Type in ('CC', 'CO', 'CP', 'CV') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and N_Course_01 >= 2 and N_Course_02 >= 4 and N_Course_03 >= 4 and N_Course_04 >= 4 and N_Course_05 >= 4 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1
		-- degrees
	...
	, max(case when N_Course_01 >= 2 and N_Course_02 >= 4 and N_Course_03 >= 4 and N_Course_04 >= 4 and N_Course_05 >= 4 and N_Course_06 >= 0 and N_Course_07 >= 0 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1 else 0 end) as Major_Req_Ind
	, max(2 + 4 + 4 + 4 + 4 + 0 + 0 + 0 + 0 + 0) as Major_Req_N
	, max(case when N_Course_01 >= 2 then 0 else 2 - N_Course_01 end) +
		max(case when N_Course_02 >= 4 then 0 else 4 - N_Course_02 end) +
		max(case when N_Course_03 >= 4 then 0 else 4 - N_Course_03 end) +
		max(case when N_Course_04 >= 4 then 0 else 4 - N_Course_04 end) +
		max(case when N_Course_05 >= 4 then 0 else 4 - N_Course_05 end) +
	...
	, max(case when N_Course_02 >= 4 then 0 else 4 - N_Course_02 end) as Gap_Major_Course_02
	, max(case when N_Course_03 >= 4 then 0 else 4 - N_Course_03 end) as Gap_Major_Course_03
	, max(case when N_Course_04 >= 4 then 0 else 4 - N_Course_04 end) as Gap_Major_Course_04
	, max(case when N_Course_05 >= 4 then 0 else 4 - N_Course_05 end) as Gap_Major_Course_05
	...
	(
		...
		, sum(case when dc.CourseID in ('MUS 54', 'MUS 55') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('MUS 3', 'MUS 4', 'MUS 5', 'MUS 6') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('MUS 53') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		, sum(case when dc.CourseID in ('MUS 39', 'MUS 40', 'MUS 42', 'MUS 44', 'MUS 46', 'MUS 59') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_04
		, sum(case when dc.CourseID in ('MUS 50', 'MUS 51', 'MUS 52') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_05
