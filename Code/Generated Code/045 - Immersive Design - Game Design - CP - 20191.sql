-- From R, need I, 20191, Immersive Design - Game Design, CP, 'IMA 20', 'IMA 22', 'IMA 40', 'IMA 98', 'IMA 99', 'IMA 191' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Immersive Design - Game Design' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('IMA 20', 'IMA 22', 'IMA 40', 'IMA 98', 'IMA 99', 'IMA 191') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
