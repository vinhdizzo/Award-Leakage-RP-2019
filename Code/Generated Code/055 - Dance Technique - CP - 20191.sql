-- From R, need I, 20191, Dance Technique, CP, 'DNCE 55' -- 'BLANK', 1 -- 0
...
(
	...
	, max(case
		-- certificates
		when a.Award_Type in ('CC', 'CO', 'CP', 'CV') and latest_gpa.CumulativeGPAAsOfEOT >= 2.0 and N_Course_01 >= 1 and N_Course_02 >= 1 and N_Course_03 >= 2 and N_Course_04 >= 1 and N_Course_05 >= 2 and N_Course_06 >= 1 and N_Course_07 >= 1 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1
		-- degrees
	...
	, sum(case when dam.BK_CollegeCode=@CoR and dam.BK_AwardTypeCode='CP' and dam.AwardMajorDesc=a.Award_Name then 1 else 0 end) as Award_Activity
	, max(case when N_Course_01 >= 1 and N_Course_02 >= 1 and N_Course_03 >= 2 and N_Course_04 >= 1 and N_Course_05 >= 2 and N_Course_06 >= 1 and N_Course_07 >= 1 and N_Course_08 >= 0 and N_Course_09 >= 0 and N_Course_10 >= 0 and (a.Ind_Group_01 + a.Ind_Group_02 + a.Ind_Group_03 + a.Ind_Group_04 + a.Ind_Group_05 + a.Ind_Group_06 + a.Ind_Group_07 + a.Ind_Group_08 + a.Ind_Group_09 + a.Ind_Group_10 + a.Ind_Group_11 + a.Ind_Group_12 >= 0) then 1 else 0 end) as Major_Req_Ind
	, max(1 + 1 + 2 + 1 + 2 + 1 + 1 + 0 + 0 + 0) as Major_Req_N
	, max(case when N_Course_01 >= 1 then 0 else 1 - N_Course_01 end) +
		...
		max(case when N_Course_04 >= 1 then 0 else 1 - N_Course_04 end) +
		max(case when N_Course_05 >= 2 then 0 else 2 - N_Course_05 end) +
	...
	, max(case when N_Course_04 >= 1 then 0 else 1 - N_Course_04 end) as Gap_Major_Course_04
	, max(case when N_Course_05 >= 2 then 0 else 2 - N_Course_05 end) as Gap_Major_Course_05
	...
	(
		...
		, sum(case when dc.CourseID in ('DNCE 55') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('DNCE 77', 'DNCE 85') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('DNCE 65', 'DNCE 66 A', 'DNCE 67 B') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		, sum(case when dc.CourseID in ('DNCE 86', 'DNCE 87', 'DNCE 88') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_04
		, sum(case when dc.CourseID in ('DNCE 7', 'DNCE 13', 'DNCE 16', 'DNCE 17', 'DNCE 18', 'DNCE 22', 'DNCE 23', 'DNCE 24', 'DNCE 25', 'DNCE 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_05
		, sum(case when dc.CourseID in ('DNCE 27', 'DNCE 33', 'DNCE 34', 'DNCE 36', 'DNCE 40', 'DNCE 61') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_06
		, sum(case when dc.CourseID in ('DNCE 51', 'DNCE 51 A', 'DNCE 51 B', 'DNCE 90', 'DNCE 91', 'DNCE 92', 'DNCE 93', 'DNCE 94', 'DNCE 95', 'DNCE 96', 'DNCE 253') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_07
