-- From R, need I, 20191, Live Entertainment Technician, CP, 'TA 41', 'TA 44', 'TA 47', 'TA 168' -- 'BLANK', 4 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Live Entertainment Technician' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('TA 41', 'TA 44', 'TA 47', 'TA 168') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('TA 142 A', 'TA 142 B', 'TA 142 C') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('TA 141 A', 'TA 141 C', 'TA 141 D') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
