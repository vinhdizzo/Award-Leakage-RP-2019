-- From R, need I, 20191, Sustainability and Resource Management, CP, 'SRM 80', 'SRM 85', 'SRM 180', 'SRM 185', 'SRM 90', 'SRM 195' -- 'BLANK', 4 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Sustainability and Resource Management' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('SRM 80', 'SRM 85', 'SRM 180', 'SRM 185', 'SRM 90', 'SRM 195') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
