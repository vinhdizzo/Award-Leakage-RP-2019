-- From R, need I, 20191, Digital Media Art, AA, 'DMA 51', 'DMA 55', 'DMA 65', 'DMA 140', 'DMA 175' -- 'BLANK', 5 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Digital Media Art' as Award_Name
		, 'AA' as Award_Type
		...
		, sum(case when dc.CourseID in ('DMA 51', 'DMA 55', 'DMA 65', 'DMA 140', 'DMA 175') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('DMA 52', 'DMA 70', 'DMA 120', 'DMA 130', 'DMA 150', 'DMA 170', 'DMA 180', 'DMA 195') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
