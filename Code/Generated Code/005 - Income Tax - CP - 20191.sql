-- From R, need I, 20191, Income Tax, CP, 'ACCT 206', 'ACCT 207' -- 'BLANK', 2 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ACCT 206', 'ACCT 207') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
