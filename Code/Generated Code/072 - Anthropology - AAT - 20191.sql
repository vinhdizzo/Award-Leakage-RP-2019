-- From R, need I, 20191, Anthropology, AAT, 'ANTH 1', 'ANTH 1 H', 'ANTH 2', 'ANTH 2 H', 'ANTH 3', 'ANTH 9' -- 'BLANK', 4 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ANTH 1', 'ANTH 1 H', 'ANTH 2', 'ANTH 2 H', 'ANTH 3', 'ANTH 9') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('BIO 11', 'ERTH 20', 'GEOG 12', 'GEOL 1', 'PSYC 2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('ANTH 4', 'ANTH 7', 'ANTH 13', 'GEOG 2', 'GEOG 20', 'HIST 33', 'HIST 40', 'HIST 41', 'HUM 2', 'HUM 21', 'HUM 22', 'PS 6', 'SOC 20') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
