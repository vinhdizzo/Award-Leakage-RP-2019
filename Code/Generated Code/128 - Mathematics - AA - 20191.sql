-- From R, need I, 20191, Mathematics, AA, 'MATH 3 A', 'MATH 3 AH', 'MATH 3 B', 'MATH 3 BH', 'MATH 4 A', 'MATH 24', 'MATH 24 H', 'MATH 26' -- 'BLANK', 5 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('MATH 3 A', 'MATH 3 AH', 'MATH 3 B', 'MATH 3 BH', 'MATH 4 A', 'MATH 24', 'MATH 24 H', 'MATH 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('PHYS 4 A', 'CS 10', 'CS 36', 'CS 37') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
