-- From R, need I, 20191, Philosophy, AA, 'PHIL 1', 'PHIL 3', 'PHIL 10', 'PHIL 11', 'WR 2' -- 'BLANK', 5 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('PHIL 1', 'PHIL 3', 'PHIL 10', 'PHIL 11', 'WR 2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('PHIL 2', 'PHIL 5') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
