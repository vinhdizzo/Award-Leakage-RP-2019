-- From R, need I, 20191, Laser Technology: Photonics, CP, 'LASR 25', 'LASR 215', 'LET 25', 'LET 215' -- 'BLANK', 2 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Laser Technology: Photonics' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('LASR 25', 'LASR 215', 'LET 25', 'LET 215') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
