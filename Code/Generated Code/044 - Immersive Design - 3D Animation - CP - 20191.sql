-- From R, need I, 20191, Immersive Design - 3D Animation, CP, 'IMA 20', 'IMA 30', 'IMA 88', 'IMA 89', 'IMA 192' -- 'BLANK', 5 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Immersive Design - 3D Animation' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('IMA 20', 'IMA 30', 'IMA 88', 'IMA 89', 'IMA 192') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
