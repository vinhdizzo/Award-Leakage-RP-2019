-- From R, need I, 20191, English, AAT, 'WR 2', 'WR 2 H', 'LIT 1' -- 'BLANK', 2 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('WR 2', 'WR 2 H', 'LIT 1') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('LIT 20', 'LIT 21', 'LIT 22', 'LIT 23') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('LIT 33', 'LIT 46', 'WR 10', 'WR 11', 'WR 13') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		, sum(case when dc.CourseID in ('LIT 7', 'LIT 24', 'LIT 30', 'LIT 31', 'LIT 32', 'LIT 40', 'LIT 41', 'LIT 43', 'LIT 45', 'LIT 48', 'LIT 49') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_04
