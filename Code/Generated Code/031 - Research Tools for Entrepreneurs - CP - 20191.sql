-- From R, need I, 20191, Research Tools for Entrepreneurs, CP, 'ENTR 200', 'ENTR 211', 'ENTR 212' -- 'BLANK', 3 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Research Tools for Entrepreneurs' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('ENTR 200', 'ENTR 211', 'ENTR 212') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
