-- From R, need I, 20191, French, AA, 'FR 1', 'FR 1 H', 'FR 2', 'FR 3', 'FR 4', 'FR 10', 'FR 11' -- 'BLANK', 6 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('FR 1', 'FR 1 H', 'FR 2', 'FR 3', 'FR 4', 'FR 10', 'FR 11') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
