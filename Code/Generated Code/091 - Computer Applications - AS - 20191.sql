-- From R, need I, 20191, Computer Applications, AS, 'CIM 103', 'CIM 107', 'CIM 112 .1', 'CIM 112 .2', 'CIM 115', 'CIM 117', 'CIM 144', 'CIM 210 .2' -- 'BLANK', 8 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Computer Applications' as Award_Name
		, 'AS' as Award_Type
		...
		, sum(case when dc.CourseID in ('CIM 103', 'CIM 107', 'CIM 112 .1', 'CIM 112 .2', 'CIM 115', 'CIM 117', 'CIM 144', 'CIM 210 .2') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('CIM 141', 'CIM 209', 'CIM 210 .1', 'CIM 212 .3') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
