-- From R, need I, 20191, Communication Studies, AA, 'COMM 1' -- 'BLANK', 1 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('COMM 2', 'COMM 3', 'COMM 5', 'COMM 9', 'COMM 30', 'COMM 35', 'COMM 100', 'COMM 106 A', 'COMM 106 B', 'COMM 106 C', 'TA 1', 'TA 12') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
