-- From R, need I, 20191, Early Childhood Associate Teacher, CP, 'HD 7', 'HD 15', 'HD 110', 'HD 115', 'HD 120' -- 'BLANK', 5 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Early Childhood Associate Teacher' as Award_Name
		, 'CP' as Award_Type
		...
		, sum(case when dc.CourseID in ('HD 7', 'HD 15', 'HD 110', 'HD 115', 'HD 120') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('HD 231', 'HD 232', 'HD 250', 'HD 251', 'HD 252', 'HD 252') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
