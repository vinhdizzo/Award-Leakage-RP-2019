-- From R, need I, 20191, Economics, AAT, 'ECON 1', 'ECON 1 H', 'ECON 2', 'ECON 2 H', 'ECON 10', 'ECON 10 H', 'MGT 10', 'MGT 10 H' -- 'BLANK', 3 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ECON 1', 'ECON 1 H', 'ECON 2', 'ECON 2 H', 'ECON 10', 'ECON 10 H', 'MGT 10', 'MGT 10 H') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('MATH 11', 'MATH 3 A', 'MATH 3 AH') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
		, sum(case when dc.CourseID in ('ACCT 1 A', 'ACCT 1 B', 'ACCT 1 BH', 'CS 1', 'CS 1 H', 'MATH 3 B', 'MATH 3 BH', 'MGT 104') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_03
		, sum(case when dc.CourseID in ('ECON 6', 'ECON 13', 'MATH 4 A', 'MATH 26') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_04
