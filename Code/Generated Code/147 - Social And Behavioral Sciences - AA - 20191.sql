-- From R, need I, 20191, Social And Behavioral Sciences, AA, 'AJ 2', 'AJ 4', 'AJ 5', 'AJ 8', 'AJ 105', 'AJ 106', 'AJ 111', 'AJ 112', 'AJ 113', 'AJ 119', 'AJ 150', 'AJ 161', 'AJ 250', 'ANTH 1', 'ANTH 2', 'ANTH 3', 'ANTH 4', 'ANTH 7', 'ANTH 9', 'ECON 1', 'ECON 2', 'ECON 6', 'ECON 13', 'ECON 20', 'ECON 105', 'GEOG 1', 'GEOG 2', 'GEOG 3', 'GEOG 38', 'GEOG 102', 'HIST 1', 'HIST 2', 'HIST 10', 'HIST 11', 'HIST 20', 'HIST 21', 'HIST 24', 'HIST 33', 'HIST 40', 'HIST 41', 'HIST 51', 'HD 7', 'HD 15', 'HD 101', 'HD 104', 'HD 105', 'HD 110', 'HD 120', 'HD 131', 'HD 145', 'HD 150', 'HD 160', 'HD 181', 'HD 266', 'HD 267', 'HD 268', 'HD 269', 'HD 270', 'HD 271', 'PS 1', 'PS 3', 'PS 4', 'PS 5', 'PS 6', 'PS 7', 'PS 12', 'PS 14', 'PS 17', 'PS 41', 'PSYC 1', 'PSYC 2', 'PSYC 3', 'PSYC 5', 'PSYC 7', 'PSYC 13', 'PSYC 30', 'PSYC 37', 'PSYC 106', 'PSYC 133', 'PSYC 160', 'SOC 1', 'SOC 2', 'SOC 10', 'SOC 15', 'SOC 19', 'SOC 20', 'SOC 30', 'WS 10', 'WS 20' -- 'BLANK', 6 -- 0
...
(
	...
	(
		select
		cur_stud.*
		, 'Social And Behavioral Sciences' as Award_Name
		, 'AA' as Award_Type
		...
		, sum(case when dc.CourseID in ('AJ 2', 'AJ 4', 'AJ 5', 'AJ 8', 'AJ 105', 'AJ 106', 'AJ 111', 'AJ 112', 'AJ 113', 'AJ 119', 'AJ 150', 'AJ 161', 'AJ 250', 'ANTH 1', 'ANTH 2', 'ANTH 3', 'ANTH 4', 'ANTH 7', 'ANTH 9', 'ECON 1', 'ECON 2', 'ECON 6', 'ECON 13', 'ECON 20', 'ECON 105', 'GEOG 1', 'GEOG 2', 'GEOG 3', 'GEOG 38', 'GEOG 102', 'HIST 1', 'HIST 2', 'HIST 10', 'HIST 11', 'HIST 20', 'HIST 21', 'HIST 24', 'HIST 33', 'HIST 40', 'HIST 41', 'HIST 51', 'HD 7', 'HD 15', 'HD 101', 'HD 104', 'HD 105', 'HD 110', 'HD 120', 'HD 131', 'HD 145', 'HD 150', 'HD 160', 'HD 181', 'HD 266', 'HD 267', 'HD 268', 'HD 269', 'HD 270', 'HD 271', 'PS 1', 'PS 3', 'PS 4', 'PS 5', 'PS 6', 'PS 7', 'PS 12', 'PS 14', 'PS 17', 'PS 41', 'PSYC 1', 'PSYC 2', 'PSYC 3', 'PSYC 5', 'PSYC 7', 'PSYC 13', 'PSYC 30', 'PSYC 37', 'PSYC 106', 'PSYC 133', 'PSYC 160', 'SOC 1', 'SOC 2', 'SOC 10', 'SOC 15', 'SOC 19', 'SOC 20', 'SOC 30', 'WS 10', 'WS 20') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		...
		, max(case when dc.CourseID in ('AJ 2', 'AJ 4', 'AJ 5', 'AJ 8', 'AJ 105', 'AJ 106', 'AJ 111', 'AJ 112', 'AJ 113', 'AJ 119', 'AJ 150', 'AJ 161', 'AJ 250') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_01
		, max(case when dc.CourseID in ('ANTH 1', 'ANTH 2', 'ANTH 3', 'ANTH 4', 'ANTH 7', 'ANTH 9') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_02
		, max(case when dc.CourseID in ('ECON 1', 'ECON 2', 'ECON 6', 'ECON 13', 'ECON 20', 'ECON 105') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_03
		, max(case when dc.CourseID in ('GEOG 1', 'GEOG 2', 'GEOG 3', 'GEOG 38', 'GEOG 102') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_04
		, max(case when dc.CourseID in ('HIST 1', 'HIST 2', 'HIST 10', 'HIST 11', 'HIST 20', 'HIST 21', 'HIST 24', 'HIST 33', 'HIST 40', 'HIST 41', 'HIST 51') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_05
		, max(case when dc.CourseID in ('HD 7', 'HD 15', 'HD 101', 'HD 104', 'HD 105', 'HD 110', 'HD 120', 'HD 131', 'HD 145', 'HD 150', 'HD 160', 'HD 181', 'HD 266', 'HD 267', 'HD 268', 'HD 269', 'HD 270', 'HD 271') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_06
		, max(case when dc.CourseID in ('PS 1', 'PS 3', 'PS 4', 'PS 5', 'PS 6', 'PS 7', 'PS 12', 'PS 14', 'PS 17', 'PS 41') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_07
		, max(case when dc.CourseID in ('PSYC 1', 'PSYC 2', 'PSYC 3', 'PSYC 5', 'PSYC 7', 'PSYC 13', 'PSYC 30', 'PSYC 37', 'PSYC 106', 'PSYC 133', 'PSYC 160') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_08
		, max(case when dc.CourseID in ('SOC 1', 'SOC 2', 'SOC 10', 'SOC 15', 'SOC 19', 'SOC 20', 'SOC 30') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_09
		, max(case when dc.CourseID in ('WS 10', 'WS 20') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as Ind_Group_10
