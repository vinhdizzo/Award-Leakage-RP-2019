-- From R, need I, 20191, Digital Media Art, CV, 'DMA 51', 'DMA 55', 'DMA 65', 'DMA 140', 'DMA 160', 'DMA 175' -- 'BLANK', 6 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('DMA 51', 'DMA 55', 'DMA 65', 'DMA 140', 'DMA 160', 'DMA 175') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('DMA 52', 'DMA 70', 'DMA 120', 'IMA 130', 'DMA 150', 'DMA 170', 'DMA 180', 'DMA 195') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
