-- From R, need I, 20191, Art History, AA, 'ARTH 4', 'ARTH 25', 'ARTH 26', 'ARTH 27', 'ARTH 104' -- 'BLANK', 5 -- 0
...
(
	...
	(
		...
		, sum(case when dc.CourseID in ('ARTH 4', 'ARTH 25', 'ARTH 26', 'ARTH 27', 'ARTH 104') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_01
		, sum(case when dc.CourseID in ('ARTH 1', 'ARTH 22', 'ARTH 23', 'ARTH 24', 'ARTH 28', 'ARTH 29', 'ARTH 30', 'ARTH 31', 'ARTH 32') and (dg.SuccessFlag=1 or (dt.BK_TermCode=@Current_TermCode and fe.DropCount=0)) then 1 else 0 end) as N_Course_02
